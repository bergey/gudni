...
, lens, linear, loop, mmorph, monad-memo, monadlist, MonadRandom
, mtl, OpenCL, OpenGL, OpenGLRaw, parallel, parallel-io, random
, sdl2, silently, stdenv, text, time, transformers, vector
}:
mkDerivation {
  pname = "gudni";
  version = "0.1.0.0";
